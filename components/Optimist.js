...
export default function Optimist(props) {
  return (
    <div>
      ...
      <div className="pt-4 w-screen flex justify-center">
        <div className=" mx-4 p-4 rounded-xl max-w-lg">
          ...
          <img className="my-2" src="/images/Optimist.png"></img>
          <p className="text-white font-bold text-center text-justify">
            Aren't you a bundle of joy? Your music scored a {props.score} on the
            happiness scale, which means i'll hand you the aux at a party.
          </p>
